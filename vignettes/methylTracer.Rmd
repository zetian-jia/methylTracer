...
abstract: |
  methylTracer processes TAPS and WGBS methylation data in large datasets
  using delayed array operations. Accurate results are obtained through Rcpp
  calls for detecting DMRs in single-cell methylation data.
vignette: |
...
package designed for whole-genome DNA methylation analysis, supporting both 
bulk and single-cell data. It efficiently processes [TAPS](https://www.nature.com/
articles/s41587-019-0041-2) and WGBS data, enabling high-throughput epigenetic 
research.

## Key Features

- **Optimized Storage & Memory Management**: 
  - *methylTracer* uses [HDF5Array](https://bioconductor.org/packages/release/bioc/
html/HDF5Array.html) to interface with [anndata](https://anndata.readthedocs.io/
en/stable/) objects. This improves memory usage and storage for large-scale datasets.

- **Fast DMR Detection**: 
  - The package leverages [Rcpp](https://cran.r-project.org/web/packages/Rcpp/index.
html) for rapid and accurate identification of de novo differentially methylated 
regions (DMRs).

- **High-Throughput Compatibility**: 
  - *methylTracer* efficiently handles large datasets, making it ideal for 
  genome-wide methylation profiling.

With its advanced computational pipeline, *methylTracer* is a scalable and 
powerful tool for researchers studying DNA methylation at both bulk and 
